...
class ExprParser [+T] (name: String, exp: SqlType[T], sql: List[query.SqlFragmentS]) // sql should probably be Option
...
class OptionalExprParser [+T] (name: String, exp: SqlType[T], sql: List[query.SqlFragmentS]) 
